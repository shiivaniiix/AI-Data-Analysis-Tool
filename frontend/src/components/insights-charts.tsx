      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2 text-xs font-semibold text-zinc-100 transition hover:border-zinc-500"
          >
        ...
        <>
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="rounded-lg border border-zinc-700 px-3 py-2 text-xs font-semibold text-zinc-100 transition hover:border-zinc-500 disabled:opacity-70"
                  >
                    Clear
                  </button>
                </div>
          ...
          <div className="mt-4 grid gap-4 lg:grid-cols-3">
            <div className="lg:col-span-1">
              {barChart ? (
                <div ref={barRef} className="rounded-xl border border-zinc-800 bg-zinc-950/40 p-3">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <button
                      ...
                      className="rounded-lg border border-zinc-700 px-2 py-1 text-[11px] font-semibold text-zinc-200 transition hover:border-zinc-500"
                    >
                      PNG
                    </button>
                  </div>
            ...
            <div className="lg:col-span-1">
              {lineChart ? (
                <div ref={lineRef} className="rounded-xl border border-zinc-800 bg-zinc-950/40 p-3">
                  <div className="flex items-start justify-between gap-2">
            ...
            <div className="lg:col-span-1">
              {pieChart ? (
                <div ref={pieRef} className="rounded-xl border border-zinc-800 bg-zinc-950/40 p-3">
                  <div className="flex items-start justify-between gap-2">
